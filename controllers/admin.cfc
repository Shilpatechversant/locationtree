...
<cffunction name="getDepth" output="true">
            ...
            <li>#arguments.folderName#
                <cfif LOCAL.qFindChildren.recordcount>
                    ...
                    <ul>
                        ...
                        <cfloop query="LOCAL.qFindChildren">
                            <!--- Recursively call function --->
                            <cfset getChild(folderId=LOCAL.qFindChildren.locationid, folderName=LOCAL.qFindChildren.locationName) />
                        </cfloop>
                    </ul>
                </cfif>
            </li>
